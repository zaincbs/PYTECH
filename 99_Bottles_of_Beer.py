...
"""99 Bottles of Beer" is a traditional song in the United States
and Canada. It is popular to sing on long trips, as it has a very
repetitive format which is easy to memorize, 
and can take a long time to sing.
...
def bottles_decrementor(n):
    ...
    for i in range(n,1,-1):
        ...
        print "Take one down, pass it around, " , bottle, " bottles of beer on the wall." 
